...
async def main():
    ...
    agent = Agent(
        name="",
        instructions="You are an expert coding agent that can help the user with their coding needs using Linear, GitHub and Slack tools effectively and efficiently. Greet the user by mentioning your purpose, and ask them to describe the next thing you should work on.",
